...
public class BlueClose extends OpMode {
    ...
    public void init(){
        ...
        follower.setStartingPose(new Pose(24 + 9.7322834608, 144 - 6.67322833945, Math.toRadians(180)));
        new Paths(follower);
        shooter = new Shooter(hardwareMap);
        turret = new Turret(hardwareMap);
        intake = new Intake (hardwareMap);
        index = new Index(hardwareMap);
        position = new Position(new Pose2D(DistanceUnit.INCH,24 + 9.7322834608, 144 - 6.67322833945, AngleUnit.DEGREES, 180  ));
        setUp();
        fsm.init();
    }
    public void loop(){
